...
```bash
uv run python -m tests.generators.compliance_runners.state_transition.tools.preview_strategy withdrawal_request --order 2
```
...
```bash
uv run python -m tests.generators.compliance_runners.state_transition.tools.preview_strategy \
...
```bash
uv run python -m tests.generators.compliance_runners.state_transition.tools.compare_strategy_funnel \
