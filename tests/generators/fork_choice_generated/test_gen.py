...
from eth2spec.gen_helpers.gen_base import args as argparser, settings
...
from test_provider import GENERATOR_NAME, create_providers, TestProvider
...
def run_test_group(test_name, test_type, instances_path,
    ...
    providers: list[TestProvider] = create_providers(test_name, forks, presets, debug, initial_seed,
...
def main():
    arg_parser = argparser.create_arg_parser()
